vim.api.nvim_create_autocmd("FileType", {
    ...
    callback = function()
        ...
        vim.keymap.set("n", "<leader>tp", ":TogglePencil<CR>", { silent = true, noremap = true, buffer = true })
        vim.keymap.set("n", "Q", "gqap", { silent = true, noremap = true, buffer = true })
        vim.keymap.set("x", "Q", "gq", { silent = true, noremap = true, buffer = true })
        ...
        vim.keymap.set("n", "<leader>N", "<cmd>ObsidianNewFromTemplate<CR>", { desc = "New Note", buffer = true })
        vim.keymap.set("n", "<leader>c", "<cmd>ObsidianTOC<CR>", { desc = "Table of Contents", buffer = true })
        ...
        vim.keymap.set("n", "<leader>t", "<cmd>ObsidianTags<CR>", { desc = "Tags", buffer = true })
        ...
        vim.keymap.set("n", "<leader>d", "<cmd>ObsidianDailies<CR>", { desc = "Daily Notes", buffer = true })
        vim.keymap.set("n", "<leader>w", "<cmd>ObsidianWorkspace<CR>", { desc = "Workspace", buffer = true })
    end,
})
